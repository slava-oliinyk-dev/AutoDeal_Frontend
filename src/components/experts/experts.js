...
const AppExperts = () => {
  ...
  const sendDataToServer = async (data) => {
    try {
      const response = await axios.post(`https://autoboy-new.vercel.app/telegram/experts`, data, {
        headers: {
        ...
        <div className="experts-content__experts">
          {leftConsultant && (
            <div className="experts-content__experts-card experts-card__one">
              <img src={`https://autoboy-new.vercel.app/uploads/${leftConsultant.photo}`} alt={leftConsultant.name} />
          ...
          {rightConsultant && (
            <div className="experts-content__experts-card experts-card__two">
              <img src={`https://autoboy-new.vercel.app/uploads/${rightConsultant.photo}`} alt={rightConsultant.name} />
